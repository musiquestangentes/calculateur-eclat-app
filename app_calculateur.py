...
# PAGE 1: LIRE SA FICHE DE PAIE
    ...
    <svg viewBox="0 0 1000 1000" width="100%" height="100%" style="font-family:sans-serif;">
        ...
        <rect x="5%" y="690" width="90%" height="25" class="block"/>
        ...
        <!-- Tableau Net à Payer -->
        <rect x="5%" y="720" width="90%" height="40" class="block"/>
